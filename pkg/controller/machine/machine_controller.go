...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &ipamv1beta1.Machine{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=ipam.k8s.io,resources=machines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ipam.k8s.io,resources=machines/status,verbs=get;update;patch
func (r *ReconcileMachine) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Machine instance
	instance := &ipamv1beta1.Machine{}
	...
	log.Info(fmt.Sprintf("add machine %+v", instance))
